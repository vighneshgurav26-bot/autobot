...
MARKETS = {
    ...
    "SOL":    {"feed": "kraken", "sym": "SOLUSD",   "spread": 0.16},
    "XAU":    {"feed": "yahoo",  "sym": "GC=F",     "spread": 0.011},
    "USTEC":  {"feed": "yahoo",  "sym": "NQ=F",     "spread": 0.004},
    "EURJPY": {"feed": "yahoo",  "sym": "EURJPY=X", "spread": 0.033},
    "EURGBP": {"feed": "yahoo",  "sym": "EURGBP=X", "spread": 0.035},
    "EURAUD": {"feed": "yahoo",  "sym": "EURAUD=X", "spread": 0.023},
    "AUDJPY": {"feed": "yahoo",  "sym": "AUDJPY=X", "spread": 0.033},
    "CHFJPY": {"feed": "yahoo",  "sym": "CHFJPY=X", "spread": 0.049},
}
...
def _yahoo(sym: str, tf_min: int, since_ms: int):
    interval = {5: "5m", 15: "15m", 60: "60m"}[tf_min]
    rng = {5: "5d", 15: "5d", 60: "1mo"}[tf_min]
    r = requests.get(
